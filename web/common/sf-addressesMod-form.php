<form class="col-10 my-5 mx-auto" action="../sf-addresses/index.php" method="post">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <textarea class="form-control" id="address" name="address" aria-describedby="addressHelp" rows="2" required><?php if(isset($addressInfo['0']['customer_address'])){ echo $addressInfo['0']['customer_address'];}?></textarea>
            ...
            <div class="col-8 my-2 mx-auto p-0">
                <button type="submit" class="w-100 btn btn-primary">Update Address</button>
