<form class="col-10 my-5 mx-auto" action="../sf-contacts/?" method="post">
            <div class="form-group row">
                <label for="book" class="col-sm-2 col-form-label">Contact Name</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="name" name="name" <?php if(isset($contactInfo['0']['contact_name'])){ echo "value='".$contactInfo['0']['contact_name']."'";}?> readonly>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="department" name="department" <?php if(isset($contactInfo['0']['contact_department'])){ echo "value='".$contactInfo['0']['contact_department']."'";}?> readonly>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="phone" name="phone" <?php if(isset($contactInfo['0']['contact_phone'])){ echo "value='".$contactInfo['0']['contact_phone']."'";}?> readonly>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="email" name="email" <?php if(isset($contactInfo['0']['contact_email'])){ echo "value='".$contactInfo['0']['contact_email']."'";}?> readonly>
