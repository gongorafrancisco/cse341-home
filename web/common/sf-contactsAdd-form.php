<form class="col-10 my-5 mx-auto" action="../sf-customers/index.php" method="post">
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="officialName" name="officialName" aria-describedby="officialNameHelp" maxlength="50" required>
                    <small id="officialNamelHelp" class="form-text text-muted">e.g. John Harris.</small>
                </div>
            </div>
            <div class="form-group row">
                <label for="book" class="col-sm-2 col-form-label">Company</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="taxID" name="taxID" aria-describedby="taxIDHelp" maxlength="13" required>
                    <small id="taxIDlHelp" class="form-text text-muted">e.g. Management</small>
                </div>
            </div>
            <div class="form-group row">
                <label for="book" class="col-sm-2 col-form-label">Company Department</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="taxID" name="taxID" aria-describedby="taxIDHelp" maxlength="13" required>
                    <small id="taxIDlHelp" class="form-text text-muted">e.g. Management</small>
                </div>
